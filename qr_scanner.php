        ...
        <ul class="nav-buttons">
            ...
            <?php
             ...
             <?php while($row = mysqli_fetch_assoc($result) ) { ?>
                ...
                <li><a href="student_info.php?cid=<?php echo $row['class_id'];?>&csec=<?php echo $row['section']; ?>&ctid=<?php echo $row['teacher_id']; ?>"><i class="ri-booklet-line"></i><?php echo $row['subject_name'] ." ". $row['section'];?></a></li>
            <?php } ?>
    ...
    <div class="main-content">
        ...
        <div class="scanner-row">
            ...
            <?php
                ...
                // zero class id solution

                if( isset($_GET['onscan']) ) {
                ...
                if( isset($_GET['error']) ) {
                    if( $_GET['error'] === "alreadyexist" ) {
                        echo "<h2 id='hide'> $name Already Recorded </h2>";
                    }
                }
            ?>
        </div>
