...
<?php
    ...
    if( isset($_POST["firstName"]) ) {
        ...
        $credCheck = "SELECT students.first_name, students.last_name, students.class_id FROM students 
                      WHERE students.first_name='$firstName' AND students.last_name='$lastName' AND students.class_id='$_SESSION[linkid]'";
        ...
        $query = "INSERT into students (first_name, middle_name, last_name, time_in, class_id, teacher_id) 
                  VALUES ('$firstName', '$middleName', '$lastName', NOW(),'$_SESSION[linkid]', $tid)";
        ...
        <ul class="nav-buttons">
            ...
            <?php
             ...
             <?php while($row = mysqli_fetch_assoc($result) ) { ?>
                ...
                <li><a class="btn-clicked" href="student_info.php?cid=<?php echo $row['class_id']; ?>&csec=<?php echo $row['section']; ?>&ctid=<?php echo $row['teacher_id']; ?>"><i class="ri-health-book-line"></i><?php echo $row['subject_name'] ." ". $row['section'];?></a></li>
            <?php } ?>
    ...
    <div class="table">
        <table>
            ...
            <tr>
                ...
                <td><button type="submit" class="update-btn" name="update-btn"><a href="operations/update.php?updateid=<?php echo $row['student_id']; ?>&classid=<?php echo $row['class_id']; ?>">Edit</a></button></td>
                <td><button type="submit" class="delete-btn" name="delete-btn"><a href="operations/delete.php?deleteid=<?php echo $row['student_id']; ?>">X</a></button></td>
            </tr>
            <?php } ?>
        </table>
    </div>
